...
export const BentoProjectCard = ({
	...
	return (
		<motion.div variants={slideUpItemVariants} className={styles}>
			...
			{PreviewComponent && (
				<div className="absolute inset-0 overflow-hidden transition-all duration-[400ms] ease-in-out grayscale group-hover:grayscale-0 group-focus-within:grayscale-0 rounded-xl">
					<PreviewComponent />
				</div>
			)}
