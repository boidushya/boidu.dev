	...
	return (
		<div className="absolute inset-0 z-0 grid place-items-center">
			<img
				...
				alt=""
				aria-hidden="true"
				className="absolute inset-0 object-cover w-full h-full scale-125 blur-2xl"
			/>
			<div className="absolute inset-0 bg-black/40" />
			<div className="relative z-10 w-24 h-24 overflow-hidden rounded-full shadow-2xl bg-zinc-950 ">
